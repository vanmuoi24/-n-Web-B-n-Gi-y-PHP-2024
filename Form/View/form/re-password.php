...
<div class="main">
        <div class="wrapper">
            ...
            <div class="right">
                <div class="sign-wrapper">
                        <h1 class="sign__heading">Quên mật khẩu!</h1>
                    <div class="sign">
                        <div class="sign__form">
                            <form action="" method="POST" autocomplete="off" class="sign__form-content" name="re-passwordform" id="re-passwordform">
                                ...
                                <input type="password" class="sign-input" name="newpassword" placeholder="Mật khẩu mới">
    ...
    <script>
        $( "#re-passwordform" ).submit(function( event ) {
            ...
            $.ajax({
                type: "POST",
                url: '../../Controller/handle/re-password_handle.php',
