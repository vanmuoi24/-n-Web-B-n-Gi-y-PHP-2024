...
<div class="main">
                ...
                <div class="sign-wrapper">
                    ...
                    <div class="sign">
                        <div class="sign__form">
                            <form action=""  method="POST"  class="sign__form-content" name="registerform" id="registerform">
                                ...
                                <!-- <input type="username" class="sign-input" name="userame" placeholder="Tên đăng nhập"> -->
    ...
    <script>
        ...
        $.ajax({
                type: "POST",
                url: '../../Controller/handle/register_handle.php',
...
$.validator.addMethod("validateUsername",function(value, element) {
    return this.optional(element) || /^kh\d+$/i.test(value);
}, "Định dạng (VD: kh1)");
    </script>
