                    ...
                    <div class="sign">
                        <div class="sign__form">
                            <!-- <form action="Re-passwordView.php" method="POST" autocomplete="off" class="sign__form-content" name="re-passwordform" id="re-passwordform"> -->
                                ...
                                <input type="password" class="sign-input" name="repassword" id="repassword" placeholder="Mật khẩu mới">
                                <span id="repassword--error" class="repassword--error error--message"></span>
                                <input type="password" class="sign-input" name="reconfirmpassword" id="reconfirmpassword" placeholder="Xác nhận mật khẩu">
                                ...
                                <input type="submit" class="btn btn--primary sign-submit" name="otpconfirm" value="Gửi mã OTP" id="otpconfirm">
                                <input type="submit" class="btn btn--primary sign-submit sign-confirmpassword" name="confirm" value="Đổi mật khẩu" id="confirm">
                            <!-- </form> -->
                        </div>
