...
// *** ĐỌC THÊM/ ẨN ĐI
function loadReadMoreNHide() {
	const btnContinue = document.querySelector('.pbm-news__btn-continue');
	const btnHidden = document.querySelector('.pmb-news__btn-hidden');

	btnContinue.addEventListener('click', (e) => {
		btnContinue.style.display = 'none';
		document.querySelector('.pmb-news__continue').classList.add('active');
		document.querySelector('.pmb-news__hidden').classList.add('active');
	});
	btnHidden.addEventListener('click', () => {
		btnContinue.style.display = 'block';
		document.querySelector('.pmb-news__continue').classList.remove('active');
		document.querySelector('.pmb-news__hidden').classList.remove('active');
	});
}

function loadProductHomeHtml(heading = 'GIÀY SNEAKER AUTHENTIC') {
	let htmls = `
	<div class="product">
	<div class="container">
		<div class="product-wrapper">
			...
			<div class="product-main">
				<div class="pm-wrapper">
					<div class="pm-top">
						<div class="pm-filter">
							<select name="" id="pm-filter-select" onchange="showProductByOrder(this)">
	...
	loadSidebar();
	document.querySelector('#page-heading').innerHTML = `<h1>${heading}</h1>`;
}
