...
function showDiscInDetail() {
	const discEleInDetail = document.querySelector('.dpmi-disc');
...
function showDetailInDetail() {
	const detailEleInDetail = document.querySelector('.dpmi-detail');
		...
		<p class="dpi-price">
         ${formatCurrency(
				product.priceProduct -
					(product.priceProduct * product.discountProduct) / 10
			)}
      </p>
      `;
		//
		discountTag = `
			<span class="detail-left__tag">-${product.discountProduct}%</span>
		`;
	}
	...
	let infoEle = `
                  ...
                  <div class="dp-info">
                     <div class="dpi-content">
                        ...
                        ${discountPrice}
                        <p class="dpi-price  --is-not-discount">${formatCurrency(
									product.priceProduct
								)}</p>
		...
		product.colorProduct.nameColor
                     ...
                     <div class="dpi-add-cart">
                        <div class="btn btn--primary dpi-add-cart-btn" id="btn-add-cart">THÊM VÀO GIỎ HÀNG</div>
                     </div>
                  </div>
...
function listSizeHtml() {
	return `
         <div class="dpi-size">
               <p>Size: </p>
               <ul class="dpis-list">
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-35>35</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-36>36</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-37>37</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-38>38</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-39>39</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-40>40</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-41>41</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-42>42</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-43>43</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-44>44</span></li>
                  <li class="dpis-item"><span class="dpis-num" data-size=sz-45>45</span></li>   
               </ul>
         </div>
