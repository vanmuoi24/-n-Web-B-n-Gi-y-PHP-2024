...
class AccountModel
{
   ...
   public function getbyid($id)
   {
      $sql = "SELECT * FROM taikhoan 
               INNER JOIN khachhang ON taikhoan.TenDN = khachhang.MaKH
               WHERE taikhoan.TenDN = '$id'";
   ...
   public function update($data)
   {
      ...
      INNER JOIN khachhang ON taikhoan.TenDN = khachhang.MaKH
      WHERE  taikhoan.TenDN != '$TenDN' AND (khachhang.Email = '$Email' OR khachhang.SDT = '$SDT')";
      ...
      $sql = " UPDATE khachhang 
               SET khachhang.Ho='$Ho',khachhang.Ten='$Ten',khachhang.Email='$Email',khachhang.DiaChi='$DiaChi',khachhang.SDT='$SDT' 
               WHERE khachhang.MaKH = '$TenDN'
      ";
      $result = $this->conn->query($sql);
      return $result ?
         array(
